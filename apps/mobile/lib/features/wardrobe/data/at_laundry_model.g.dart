...
_$AtLaundryItemImpl _$$AtLaundryItemImplFromJson(
...
Map<String, dynamic> _$$AtLaundryItemImplToJson(
  _$AtLaundryItemImpl instance,
) => <String, dynamic>{
...
_$AtLaundryDataImpl _$$AtLaundryDataImplFromJson(
  Map<String, dynamic> json,
) => _$AtLaundryDataImpl(
...
Map<String, dynamic> _$$AtLaundryDataImplToJson(
  _$AtLaundryDataImpl instance,
) => <String, dynamic>{
